        ...
        <form onSubmit={this.props.submitEvent}>
          ...
          <div className="form-group col-md-3">
            ...
            <input
              ...
              onChange={this.props.changeSdate}
              type="date"
              className="form-control"
              id="inputTime"
            />
          ...
          <div className="form-group col-md-3">
            ...
            <input
              ...
              onChange={this.props.changeStime}
              type="time"
              className="form-control"
              id="inputTime"
            />
          ...
          <div className="form-group col-md-3">
            ...
            <input
              ...
              onChange={this.props.changeEdate}
              type="date"
              className="form-control"
              id="inputTime"
            />
          ...
          <div className="form-group col-md-3">
            ...
            <input
              ...
              onChange={this.props.changeEtime}
              type="time"
              className="form-control"
              id="inputTime"
            />
