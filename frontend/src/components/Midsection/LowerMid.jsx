        ...
        return (
            <div className="lowermid">
                <div className="container">
                    ...
                    <h5 className="text-center">Mar 9. 2019 - Let's Do 300! Emergency Care Package Drive</h5>

                    <div>
                        <p>Join Young Masterbuilders In Motion on March 9th at Rogers Park Library to collect and
                    package essential supplies for foster youth</p>
                        <p>It's estimated that 5,000 youth age out of foster care in the Chicagoland  area each year.
