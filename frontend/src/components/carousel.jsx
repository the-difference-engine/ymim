        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <div className="overlay">
              ...
              <p className="paragraph-carousel">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
              <Navbar.Brand className="logo-div">
                <img style={inline} className="logo" src={logo} alt="YMIM" />
              </Navbar.Brand>
            </div>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <div class="overlay">
              ...
              <p className="paragraph-carousel">Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
              <Navbar.Brand className="logo-div">
                <img style={inline} className="logo" src={logo} alt="YMIM" />
              </Navbar.Brand>
            </div>
