...
import { Container, Jumbotron, ListGroup, ListGroupItem, Card, Accordion, Button } from 'react-bootstrap';
			...
			<Container fluid={true} className="px-4">
				...
				<Jumbotron className="test" id="hospital">
					...
					<p className="resource-p2">
						Nisi excepteur occaecat id quis enim id occaecat nostrud officia qui laboris nostrud. Irure aute
						ipsum proident proident ipsum commodo consequat irure in. Voluptate irure aliquip nulla in
						laborum do est in ullamco ipsum consequat. Aute aliqua dolor reprehenderit dolore duis cupidatat
						sint Lorem ad reprehenderit pariatur enim sint. Aliqua incididunt voluptate nisi adipisicing est
						voluptate esse reprehenderit irure commodo commodo. Quis incididunt adipisicing do ullamco ea
						nulla veniam. Sunt nostrud magna occaecat ad anim id. Ea labore sint ea ex ad qui sint consequat
						duis labore. Cillum excepteur fugiat ipsum do dolor et.
					</p>
				</Jumbotron>
				<Jumbotron className="test1" id="uc">
					...
					<Accordion defaultActiveKey="0">
						<Card>
							<Card.Header>
								<Accordion.Toggle className="resource-p2" as={Button} variant="link" eventKey="1">
