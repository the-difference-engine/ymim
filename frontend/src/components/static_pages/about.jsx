          ...
          <Row>
            <Col >
              ...
              <div className="aboutSection">
                <h2>Join us!</h2>
                <p>
                  <Link to="/enrollment">Enroll</Link> today for the 2019 cohort. Applications are now being accepted. Qualifications are for young women, who are orphans, adoptees, and foster youth alumnae up to age 30\. Referrals and recommendations are welcome.
            </p>
              </div>
              ...
              <div className="aboutSection">
                ...
                <p>Consider becoming a <Link to="/become-a-sponsor">Sponsor</Link> on behalf of foster alumnae today. Your recurring or one-time tax deductible gifts matters!</p>

                <p><Link to="/contact-us">Contact us now!</Link>
            </p>
              </div>
