...
class Contact extends Component {
  ...
  handleChange = event => {
    ...
    switch (name) {
      case "name":
        errors.name =
          value.length < 5 ? "Full Number must  5 characters long!" : "";
      ...
      case "phone":
        errors.number = validPhoneRegex.test(value)
          ? ""
          : "Enter valid numbers (xxx)xxx-xxxx, letters  are not acceptable";

        break;

      case "message":
        errors.isLimit =
          value.length < 255 ? "" : "You have exceeded the text limit of 255";
